...
Based on the automated selection of variables there is no real difference in using a model with two variables versus using one with all of the variables. This was identified through each of our graphical depictions of the adjusted rsquared as well as the residual standard error.
